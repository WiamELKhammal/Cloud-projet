        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={7}>
            ...
            <Typography sx={{ color: 'text.secondary', mb: 2, ml: { xs: 0, md: 4 } }}>
              Set your learning and project management pace according to your preferences, with the added benefits of a
              collaborative platform that enhances your university projects.
            </Typography>
